function ProductCard({ product, addToCart }) {
  return (
    <article className='pmin-w-[180px] max-w-[250px] lg:min-w-[140px] md:min-w-[140px] ssm:max-w-[100%]'>
      ...
      <h2 className='font-[700] text-[1.2rem] lg:text-[1rem] md:text-[.8rem]'>{product.name}</h2>
      <div className='flex justify-between items-center'>
        ...
        <p className='text-[1.4rem] font-[600] lg:text-[1.2rem] md:text-[1rem]'>${product.price}</p>
      </div>
      <button
